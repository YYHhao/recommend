...
# 用户信息
user_df = pd.read_csv('recommend\\DoubanMovieRecommendation_code\\data\\douban_users.csv')
user_df = user_df.iloc[:,[1,2,3]]

# 电影信息
movies_df = pd.read_csv('recommend\\DoubanMovieRecommendation_code\\data\\doubanMovies.csv', encoding='utf-8')
